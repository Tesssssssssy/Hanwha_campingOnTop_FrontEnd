  ...
  if (signupAgreementWrapper) {
    ...
    if (signupContainer) {
      ...
      signupEmailWrapper.innerHTML =
        '<h4 class="signup-email-title">회원가입을 위한 필수 정보를 <br>입력해주세요.</h4><div class="signup-email-contents"><input class="signup-email-input" placeholder="아이디 (이메일) 입력" oninput="validationEmail(this)" type="text" id="email" name="email"></div><div class="signup-email-contents"><input class="signup-email-input" placeholder="비밀번호 입력" type="password" id="password" name="password"></div><div class="signup-email-contents"><input class="signup-email-input" placeholder="비밀번호 확인" type="password" id="passwordCheck" name="passwordCheck"></div><div class="signup-email-contents"><input class="signup-email-input" placeholder="성명" type="text" id="name" name="name"></div><div class="signup-email-contents"><input class="signup-email-input" placeholder="닉네임" type="nickName" id="nickName" name="nickName"></div><div class="signup-email-contents"><input class="signup-email-input" placeholder="성별 (M / F)" type="gender" id="gender" name="gender"></div><div class="signup-email-contents"><input class="signup-email-input" placeholder="핸드폰 번호" type="phoneNum" id="phoneNum" name="phoneNum"></div><button onclick="submitRegistration()" class="signup-progress-btn disabled" id="signupBtn" type="button" disabled>다음</button>';
